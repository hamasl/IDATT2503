...
if __name__ == '__main__':
    print("Task a:")
    n_a = 1829
    print(pollard_p_minus_one(n_a, 1828))
    print(pollard_p_minus_one(n_a, 59))
    print(pollard_p_minus_one(n_a, 31))
    ...
    #TODO remove
    print(pollard_p_minus_one(18779, 10))
    print(pollard_p_minus_one(42583, 6))
